...
A custom _printf() for learning purposes was developed by cohort  #11 students  Emmanuel Essien and Esther Ewaia _printf() function format string is a character string, beginning and ending in its initial shift state, if any. 
